...
<h3 class="style1"><font color="white">Lab Management System</font></h3>
</ul>
...
<fieldset>
<legend><h3 class="style2">Update Extension</h3></legend>
...
<br></br>
<input type="hidden" value="extensionupdate" name="activity"/>
