...
<ul class="menu">
         ...
         <li><a href="LabSearchLO.jsp">Lab Search</a> </li>
         <li><a href="LabRequest.jsp">Lab Request </a> </li>
		 <li><a href="LabReleaseRequest.jsp">Lab Release</a> </li>
		 <li><a href="LabExtensionRequest.jsp">Lab Extension</a></li>
		 <li><a href="LabStatus.jsp">Status</a></li>
		 </ul>
